  ...
  return (
    <nav className="bg-gray-800 p-4 text-white">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div
          className={`absolute md:static top-16 left-0 w-full md:w-auto bg-gray-800 md:bg-transparent p-6 md:p-0 md:flex md:items-center transition-all flex-col md:flex-row items-center  ${
            isOpen ? "flex" : "hidden"
          }`}
        >
